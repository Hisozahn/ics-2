   ...
   2175 75 0C 00            397 	mov	_old_led,#0x00
                            398 ;	SRC/led.c:117: unsigned char tick = 1;
   2178 75 0D 01            399 	mov	_tick,#0x01
                            400 ;	SRC/led.c:118: unsigned char brightness[LED_COUNT] = {0, 0, 0, 0, 0, 0, 0, 0};
   217B 75 0E 00            401 	mov	_brightness,#0x00
   217E 75 0F 00            402 	mov	(_brightness + 0x0001),#0x00
   2181 75 10 00            403 	mov	(_brightness + 0x0002),#0x00
   2184 75 11 00            404 	mov	(_brightness + 0x0003),#0x00
   2187 75 12 00            405 	mov	(_brightness + 0x0004),#0x00
   218A 75 13 00            406 	mov	(_brightness + 0x0005),#0x00
   218D 75 14 00            407 	mov	(_brightness + 0x0006),#0x00
   2190 75 15 00            408 	mov	(_brightness + 0x0007),#0x00
                            409 ;--------------------------------------------------------
                            410 ; Home
                            411 ;--------------------------------------------------------
                            412 	.area HOME    (CODE)
   ...
   234E                     430 _led:
                    ...
                    0001    437 	ar1 = 0x01
                    0000    438 	ar0 = 0x00
   234E C0 19               439 	push	_bp
   2350 85 81 19            440 	mov	_bp,sp
                            441 ;	SRC/led.c:58: if( n > 7 ) return;
   2353 E5 82               442 	mov	a,dpl
   2355 FF                  443 	mov	r7,a
   2356 24 F8               444 	add	a,#0xff - 0x07
   2358 50 02               445 	jnc	00102$
   235A 80 32               446 	sjmp	00106$
   235C                     447 00102$:
                            448 ;	SRC/led.c:60: c = old_led;
   235C AE 0C               449 	mov	r6,_old_led
                            450 ;	SRC/led.c:62: mask <<= n;
   235E 8F F0               451 	mov	b,r7
   2360 05 F0               452 	inc	b
   2362 74 01               453 	mov	a,#0x01
   2364 80 02               454 	sjmp	00115$
   2366                     455 00113$:
   2366 25 E0               456 	add	a,acc
   2368                     457 00115$:
   2368 D5 F0 FB            458 	djnz	b,00113$
   236B FF                  459 	mov	r7,a
                            460 ;	SRC/led.c:64: if( on )
   236C E5 19               461 	mov	a,_bp
   236E 24 FD               462 	add	a,#0xfd
   2370 F8                  463 	mov	r0,a
   2371 E6                  464 	mov	a,@r0
   2372 60 05               465 	jz	00104$
                            466 ;	SRC/led.c:65: c |= mask;
   2374 EF                  467 	mov	a,r7
   2375 42 06               468 	orl	ar6,a
   2377 80 05               469 	sjmp	00105$
   2379                     470 00104$:
                            471 ;	SRC/led.c:67: c &= ~mask;         
   2379 EF                  472 	mov	a,r7
   237A F4                  473 	cpl	a
   237B FF                  474 	mov	r7,a
   237C 52 06               475 	anl	ar6,a
   237E                     476 00105$:
                            477 ;	SRC/led.c:69: write_max( SV, c );     
   237E C0 06               478 	push	ar6
   2380 C0 06               479 	push	ar6
   2382 90 00 07            480 	mov	dptr,#0x0007
   2385 12 24 53            481 	lcall	_write_max
   2388 15 81               482 	dec	sp
   238A D0 06               483 	pop	ar6
                            484 ;	SRC/led.c:71: old_led = c;
   238C 8E 0C               485 	mov	_old_led,r6
   238E                     486 00106$:
   238E D0 19               487 	pop	_bp
   2390 22                  488 	ret
                            489 ;------------------------------------------------------------
                            ...
                            497 ;	-----------------------------------------
   2391                     498 _leds:
   2391 AF 82               499 	mov	r7,dpl
                            500 ;	SRC/led.c:92: write_max( SV, on );     
   2393 C0 07               501 	push	ar7
   2395 C0 07               502 	push	ar7
   2397 90 00 07            503 	mov	dptr,#0x0007
   239A 12 24 53            504 	lcall	_write_max
   239D 15 81               505 	dec	sp
   239F D0 07               506 	pop	ar7
                            507 ;	SRC/led.c:94: old_led = on;
   23A1 8F 0C               508 	mov	_old_led,r7
   23A3 22                  509 	ret
                            510 ;------------------------------------------------------------
                            ...
                            518 ;	-----------------------------------------
   23A4                     519 _WriteLED:
   23A4 AF 82               520 	mov	r7,dpl
                            521 ;	SRC/led.c:107: write_max( 7, value );
   23A6 C0 07               522 	push	ar7
   23A8 90 00 07            523 	mov	dptr,#0x0007
   23AB 12 24 53            524 	lcall	_write_max
   23AE 15 81               525 	dec	sp
   23B0 22                  526 	ret
                            527 ;------------------------------------------------------------
                            ...
                            537 ;	-----------------------------------------
   23B1                     538 _T0_ISR:
   23B1 C0 E0               539 	push	acc
   23B3 C0 07               540 	push	ar7
   23B5 C0 06               541 	push	ar6
   23B7 C0 05               542 	push	ar5
   23B9 C0 04               543 	push	ar4
   23BB C0 01               544 	push	ar1
   23BD C0 D0               545 	push	psw
   23BF 75 D0 00            546 	mov	psw,#0x00
                            547 ;	SRC/led.c:123: unsigned char led = 0;
   23C2 7F 00               548 	mov	r7,#0x00
                            549 ;	SRC/led.c:124: unsigned char mask = 1;	
   23C4 7E 01               550 	mov	r6,#0x01
                            551 ;	SRC/led.c:126: if (tick > 50) {
   23C6 E5 0D               552 	mov	a,_tick
   23C8 24 CD               553 	add	a,#0xff - 0x32
   23CA 50 03               554 	jnc	00114$
                            555 ;	SRC/led.c:127: tick = 1;
   23CC 75 0D 01            556 	mov	_tick,#0x01
   23CF                     557 00114$:
   23CF 7D 00               558 	mov	r5,#0x00
   23D1                     559 00105$:
                            560 ;	SRC/led.c:129: for (; i < LED_COUNT; i++) {		
   23D1 BD 08 00            561 	cjne	r5,#0x08,00121$
   23D4                     562 00121$:
   23D4 50 17               563 	jnc	00108$
                            564 ;	SRC/led.c:130: if (tick < brightness[i]/2) {			
   23D6 ED                  565 	mov	a,r5
   23D7 24 0E               566 	add	a,#_brightness
   23D9 F9                  567 	mov	r1,a
   23DA E7                  568 	mov	a,@r1
   23DB C3                  569 	clr	c
   23DC 13                  570 	rrc	a
   23DD FC                  571 	mov	r4,a
   23DE C3                  572 	clr	c
   23DF E5 0D               573 	mov	a,_tick
   23E1 9C                  574 	subb	a,r4
   23E2 50 03               575 	jnc	00104$
                            576 ;	SRC/led.c:131: led += mask;
   23E4 EE                  577 	mov	a,r6
   23E5 2F                  578 	add	a,r7
   23E6 FF                  579 	mov	r7,a
   23E7                     580 00104$:
                            581 ;	SRC/led.c:133: mask <<= 1;
   23E7 EE                  582 	mov	a,r6
   23E8 2E                  583 	add	a,r6
   23E9 FE                  584 	mov	r6,a
                            585 ;	SRC/led.c:129: for (; i < LED_COUNT; i++) {		
   23EA 0D                  586 	inc	r5
   23EB 80 E4               587 	sjmp	00105$
   23ED                     588 00108$:
                            589 ;	SRC/led.c:135: tick++;
   23ED 05 0D               590 	inc	_tick
                            591 ;	SRC/led.c:137: TH0 = 0xFF;
   23EF 75 8C FF            592 	mov	_TH0,#0xFF
                            593 ;	SRC/led.c:138: TL0 = 0xF0;
   23F2 75 8A F0            594 	mov	_TL0,#0xF0
   23F5 D0 D0               595 	pop	psw
   23F7 D0 01               596 	pop	ar1
   23F9 D0 04               597 	pop	ar4
   23FB D0 05               598 	pop	ar5
   23FD D0 06               599 	pop	ar6
   23FF D0 07               600 	pop	ar7
   2401 D0 E0               601 	pop	acc
   2403 32                  602 	reti
                            ...
                            616 ;	-----------------------------------------
   2404                     617 _SetBrightness:
   2404 C0 19               618 	push	_bp
   2406 85 81 19            619 	mov	_bp,sp
   2409 AF 82               620 	mov	r7,dpl
                            621 ;	SRC/led.c:142: if (b > 100) {
   240B E5 19               622 	mov	a,_bp
   240D 24 FD               623 	add	a,#0xfd
   240F F8                  624 	mov	r0,a
   2410 E6                  625 	mov	a,@r0
   2411 24 9B               626 	add	a,#0xff - 0x64
   2413 50 02               627 	jnc	00102$
                            628 ;	SRC/led.c:143: return;
   2415 80 12               629 	sjmp	00105$
   2417                     630 00102$:
                            631 ;	SRC/led.c:146: if (ledId > LED_COUNT - 1) {
   2417 EF                  632 	mov	a,r7
   2418 24 F8               633 	add	a,#0xff - 0x07
   241A 50 02               634 	jnc	00104$
                            635 ;	SRC/led.c:147: return;
   241C 80 0B               636 	sjmp	00105$
   241E                     637 00104$:
                            638 ;	SRC/led.c:150: brightness[ledId] = b;
   241E EF                  639 	mov	a,r7
   241F 24 0E               640 	add	a,#_brightness
   2421 F8                  641 	mov	r0,a
   2422 E5 19               642 	mov	a,_bp
   2424 24 FD               643 	add	a,#0xfd
   2426 F9                  644 	mov	r1,a
   2427 E7                  645 	mov	a,@r1
   2428 F6                  646 	mov	@r0,a
   2429                     647 00105$:
   2429 D0 19               648 	pop	_bp
   242B 22                  649 	ret
                            650 ;------------------------------------------------------------
                            ...
                            658 ;	-----------------------------------------
   242C                     659 _SetBrightnesses:
   242C AD 82               660 	mov	r5,dpl
   242E AE 83               661 	mov	r6,dph
   2430 AF F0               662 	mov	r7,b
                            663 ;	SRC/led.c:154: ET0 = 0;
   2432 C2 A9               664 	clr	_ET0
                            665 ;	SRC/led.c:155: memcpy(brightness, brigthness_v, LED_COUNT);
   2434 74 08               666 	mov	a,#0x08
   2436 C0 E0               667 	push	acc
   2438 E4                  668 	clr	a
   2439 C0 E0               669 	push	acc
   243B C0 05               670 	push	ar5
   243D C0 06               671 	push	ar6
   243F C0 07               672 	push	ar7
   2441 90 00 0E            673 	mov	dptr,#_brightness
   2444 75 F0 40            674 	mov	b,#0x40
   2447 12 26 9A            675 	lcall	_memcpy
   244A E5 81               676 	mov	a,sp
   244C 24 FB               677 	add	a,#0xfb
   244E F5 81               678 	mov	sp,a
                            679 ;	SRC/led.c:156: ET0 = 1;
   2450 D2 A9               680 	setb	_ET0
   2452 22                  681 	ret
                            682 	.area CSEG    (CODE)
                            683 	.area CONST   (CODE)
                            684 	.area XINIT   (CODE)
